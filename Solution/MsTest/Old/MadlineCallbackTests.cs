...
//            // 이건 예약되기만 해야함(false)
//            var isWritten = this.Madline.Writer.TryWrite(rawSource);
//            Assert.IsFalse(isWritten);

//            this.Madline.Reader.TryRead(out var result2);

//            // Advance 이후 예약된 WriteAsync가 재실행
//            this.Madline.Reader.Advance(result2.End);
//        }


//        [TestMethod]
//        public void WriteTestWithThread()
//        {
//            var rawSource = new byte[] { 1, 2, 3 };
